...
self.planets = [[NSMutableArray alloc] init];
    ...
    for (NSMutableDictionary *planetData in [AstronomicalData allKnownPlanets])
    {
        ...
        TGSpaceObject *planet = [[TGSpaceObject alloc] initWithData:planetData andImage:[UIImage imageNamed:imageName]];
...
//    NSString *planet8 = @"Neptune";
    ...
    //self.planets = [[NSMutableArray alloc] initWithObjects:planet1,planet2,planet3,planet4,planet5,planet6,planet7,planet8, nil]; //this initWithObjects replaced all addObject below
